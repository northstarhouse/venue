-- Adds the 4 confirmed photos into the Initial Inquiry email: a hero shot
-- up top, and a 3-photo strip after the intro paragraph (matching the
-- original guide's layout). Google Photos share-link CDN URLs (lh3.googleusercontent.com)
-- are stable/public and support on-the-fly resizing via the =wNNN suffix.

update venue_email_templates set html_body = $HTML$
<img src="https://lh3.googleusercontent.com/pw/AP1GczPubpbJyHpzD3NclxJTAKgNFi54EddI2WNW3lcNiRURFqa3NwjPFP5oEGLOWCPibM5YHdhNEEX2TM2bow59P9rKbTb07cdguwl9M20gclCFRboLjsQ=w800" width="100%" alt="North Star House" style="display:block;border-radius:12px;margin:0 0 24px;" />
...
<table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin:0 0 24px;">
  <tr>
    <td width="33.33%" style="padding:0 4px 0 0;"><img src="https://lh3.googleusercontent.com/pw/AP1GczNgghck7lcxH05K2m-B_Wmzt4xSx9flYmUxYLLAugsN_M9p9M22Ln7NRJs9zUV4rZktQpM8P9R8Hg7dqgi6LsEAHPdyRidzuHLgXzhSfNAywEoa84E=w400" width="100%" alt="Garden path" style="display:block;border-radius:8px;" /></td>
    <td width="33.33%" style="padding:0 4px;"><img src="https://lh3.googleusercontent.com/pw/AP1GczNBLLR55YZVqa8EhTFGdh9g7TOdzgZdQruJrZcbTNewfsx-X65xF28e1IH7LAzQ2CYn6ZuxbNHuuWPNw9uqmlMC6gN17oMdi0lQsU7OQp0XKIkc_JA=w400" width="100%" alt="Outdoor reception" style="display:block;border-radius:8px;" /></td>
